...
import { generateSeaAnimalQuizQuestions, SeaAnimalQuizQuestion } from '../utils/seaAnimalQuizGenerator';
import './DinosaurQuiz.css';

const SeaAnimalsQuiz: React.FC = () => {
  const [questions, setQuestions] = useState<SeaAnimalQuizQuestion[]>([]);
  ...
  const startQuiz = () => {
    const newQuestions = generateSeaAnimalQuizQuestions(10);
    ...
    return (
      <div className="quiz-container">
        <div className="quiz-start">
          <h1>🐠 Sea Animals Quiz! 🐋</h1>
          <div className="quiz-info">
            <h2>Ready to test your sea animal knowledge?</h2>
            <ul>
              <li>🎯 10 exciting questions</li>
              <li>⏰ 30 seconds per question</li>
              <li>🖼️ Beautiful sea animal images</li>
  ...
  if (gameState === 'finished') {
    ...
    if (percentage >= 90) {
      message = 'Amazing! You\'re a sea animal expert!';
      emoji = '🏆';
    } else if (percentage >= 70) {
      message = 'Great job! You know your sea animals well!';
      emoji = '🎉';
    } else if (percentage >= 50) {
      message = 'Good effort! Keep learning about sea animals!';
      emoji = '👍';
    } else {
  ...
  return (
    <div className="quiz-container">
      ...
      <div className="question-container">
        <div className="sea-animal-image">
          <img 
            src={question.image} 
            alt={`Sea Animal: ${question.correctAnswer}`}
            onError={(e) => {
          ...
          {imageError && (
            <div className="image-error">
              ...
              <p>Can you guess this sea animal?</p>
            </div>
          )}
        </div>
